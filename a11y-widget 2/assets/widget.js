...
`; }
  ...
  function updateMonophtalmieLowVisionStyle(){
    ...
    const selector = `html[data-a11yVisionMonophtalmie="on"]`;
    styleEl.textContent = [
      '/* Mode vision basse monophtalmie */',
      `${selector} body { background: #000 !important; color: #fff !important; }`,
      `${selector} body *:not(#a11y-widget-root):not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier):not(#a11y-monophtalmie-magnifier *) { color: #fff !important; background-color: transparent !important; }`,
      `${selector} div:not(#a11y-widget-root):not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} section:not(#a11y-widget-root):not(#a11y-monophtalmie-magnifier),`,
      `${selector} article:not(#a11y-widget-root):not(#a11y-monophtalmie-magnifier),`,
      `${selector} main:not(#a11y-widget-root):not(#a11y-monophtalmie-magnifier),`,
      `${selector} aside:not(#a11y-widget-root):not(#a11y-monophtalmie-magnifier),`,
      `${selector} header:not(#a11y-widget-root):not(#a11y-monophtalmie-magnifier),`,
      `${selector} footer:not(#a11y-widget-root):not(#a11y-monophtalmie-magnifier),`,
      `${selector} nav:not(#a11y-widget-root):not(#a11y-monophtalmie-magnifier) { background: #000 !important; background-color: #000 !important; }`,
      `${selector} p:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} li:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} td:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} th:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} span:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} label:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} strong:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} b:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} em:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} i:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} small:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} code:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} pre:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} blockquote:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} cite:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} mark:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} time:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} address:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} dd:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} dt:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} figcaption:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} caption:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} legend:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *) { color: #fff !important; font-size: 115% !important; line-height: 1.7 !important; background-color: transparent !important; }`,
      `${selector} h1:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} h2:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} h3:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} h4:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} h5:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} h6:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *) { color: #fff !important; background-color: transparent !important; }`,
      `${selector} h1:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *) { font-size: 2.4em !important; }`,
      `${selector} h2:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *) { font-size: 2em !important; }`,
      `${selector} h3:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *) { font-size: 1.7em !important; }`,
      `${selector} h4:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} h5:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} h6:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *) { font-size: 1.4em !important; }`,
      `${selector} a:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *) { color: #4dabf7 !important; background-color: transparent !important; text-decoration: underline !important; font-weight: 700 !important; padding: 2px 4px !important; }`,
      `${selector} a:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *):hover,`,
      `${selector} a:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *):focus { background: #4dabf7 !important; background-color: #4dabf7 !important; color: #000 !important; }`,
      `${selector} button:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} input:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *):not([type="checkbox"]):not([type="radio"]),`,
      `${selector} select:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} textarea:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *) { background: #222 !important; background-color: #222 !important; color: #fff !important; border: 3px solid #fff !important; font-size: 115% !important; padding: 14px 22px !important; min-height: 50px !important; font-weight: 600 !important; }`,
      `${selector} button:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *):hover { background: #4dabf7 !important; background-color: #4dabf7 !important; color: #000 !important; border-color: #4dabf7 !important; }`,
      `${selector} img:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *) { filter: contrast(1.4) brightness(1.2) !important; border: 3px solid #fff !important; }`,
      `${selector} table:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *) { border: 3px solid #fff !important; background: #000 !important; background-color: #000 !important; }`,
      `${selector} table:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *) th,`,
      `${selector} table:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *) td { border: 2px solid #fff !important; padding: 12px !important; color: #fff !important; background-color: #000 !important; }`,
      `${selector} tbody:not(#a11y-widget-root *),`,
      `${selector} thead:not(#a11y-widget-root *),`,
      `${selector} tfoot:not(#a11y-widget-root *),`,
      `${selector} tr:not(#a11y-widget-root *) { background: #000 !important; background-color: #000 !important; }`,
      `${selector} ul:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} ol:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *) { padding-left: 30px !important; color: #fff !important; }`,
      `${selector} pre:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *),`,
      `${selector} code:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *) { background: #1a1a1a !important; background-color: #1a1a1a !important; color: #fff !important; border: 2px solid #fff !important; }`,
      `${selector} blockquote:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *) { border-left: 5px solid #4dabf7 !important; padding-left: 15px !important; color: #fff !important; background: #1a1a1a !important; background-color: #1a1a1a !important; }`,
      `${selector} *:not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier *):focus { outline: 4px solid #4dabf7 !important; outline-offset: 3px !important; }`,
      `${selector} [class]:not(#a11y-widget-root):not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier):not(#a11y-monophtalmie-magnifier *):not(body):not(html),`,
      `${selector} [id]:not(#a11y-widget-root):not(#a11y-widget-root *):not(#a11y-monophtalmie-magnifier):not(#a11y-monophtalmie-magnifier *):not(body):not(html) { color: #fff !important; }`,
      `${selector} #content:not(#a11y-widget-root):not(#a11y-monophtalmie-magnifier),`,
      `${selector} #main:not(#a11y-widget-root):not(#a11y-monophtalmie-magnifier),`,
      `${selector} #primary:not(#a11y-widget-root):not(#a11y-monophtalmie-magnifier),`,
      `${selector} .content:not(#a11y-widget-root):not(#a11y-monophtalmie-magnifier),`,
      `${selector} .main:not(#a11y-widget-root):not(#a11y-monophtalmie-magnifier),`,
      `${selector} .site-content:not(#a11y-widget-root):not(#a11y-monophtalmie-magnifier) { background: #000 !important; background-color: #000 !important; }`,
