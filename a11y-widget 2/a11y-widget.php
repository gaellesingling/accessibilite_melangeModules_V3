        ...
        array(
            ...
            'children' => array(
                ...
                array(
                    ...
                    'hint'       => __( 'Réduction de l’éblouissement, correction des couleurs et netteté renforcée.', 'a11y-widget' ),
                    'template'   => 'cataract-support',
                    'settings'   => array(
                        'intro'                => __( 'Ces outils compensent la vision floue, l’éblouissement et la mauvaise perception des couleurs liés à la cataracte.', 'a11y-widget' ),
                        'reset_label'          => __( 'Réinitialiser les réglages cataracte', 'a11y-widget' ),
                        'reset_aria'           => __( 'Réinitialiser tous les réglages appliqués pour la cataracte', 'a11y-widget' ),
                        'intensity_help'       => __( 'Faites glisser pour adapter la force du filtre anti-éblouissement (10 % à 40 %).', 'a11y-widget' ),
                        'intensity_unit'       => __( '%', 'a11y-widget' ),
                        'intensity_decrease'   => __( 'Réduire', 'a11y-widget' ),
                        'intensity_increase'   => __( 'Augmenter', 'a11y-widget' ),
                    ),
                    'children'   => array(
                        array(
                            'slug'        => 'reduce_glare',
                            ...
                            'hint'        => __( 'Filtre les lumières vives et limite les reflets gênants.', 'a11y-widget' ),
                        ),
                        array(
                            ...
                            'hint'        => __( 'Réglez la puissance du filtre anti-éblouissement selon votre confort.', 'a11y-widget' ),
                            'settings'    => array(
                                'min'  => 10,
                                'max'  => 40,
                                'step' => 5,
                        ...
                        array(
                            ...
                            'hint'        => __( 'Compense le jaunissement et renforce les contrastes doux.', 'a11y-widget' ),
                        ),
                        array(
                            'slug'        => 'sharpness',
                            ...
                            'hint'        => __( 'Accentue légèrement le texte et les images pour les rendre plus nets.', 'a11y-widget' ),
                        ),
                        array(
                            'slug'        => 'remove_effects',
                            'label'       => __( 'Supprimer les effets visuels', 'a11y-widget' ),
                            'aria_label'  => __( 'Activer la suppression des animations et halos visuels', 'a11y-widget' ),
                            'hint'        => __( 'Supprime animations, halos et effets visuels qui fatiguent la vision.', 'a11y-widget' ),
                        ),
                    ),
                ),
                array(
        ...
        array(
            ...
            'children' => array(
                array(
                    ...
                    'hint'       => __( 'Traduction rapide au format Grade 2.', 'a11y-widget' ),
                    'aria_label' => __( 'Activer le traducteur braille contracté', 'a11y-widget' ),
                    'template'   => 'braille-translator',
                    'settings'   => array(
                        'mode'               => 'contracted',
                        'intro'              => __( 'Sélectionnez un texte sur la page ou saisissez votre propre contenu pour obtenir sa traduction en braille contracté.', 'a11y-widget' ),
                        'selection_label'    => __( 'Texte sélectionné', 'a11y-widget' ),
                        'selection_empty'    => __( 'Sélectionnez du texte dans la page pour l’afficher ici.', 'a11y-widget' ),
                        'selection_hint'     => __( 'Activez cette option, puis surlignez un passage : vous pourrez ensuite lancer la traduction instantanément.', 'a11y-widget' ),
                        ...
                        'manual_label'       => __( 'Traduire un texte saisi', 'a11y-widget' ),
                        'manual_placeholder' => __( 'Tapez ou collez votre texte ici…', 'a11y-widget' ),
                        'manual_button'      => __( 'Traduire ce texte', 'a11y-widget' ),
                        'manual_clear'       => __( 'Effacer le texte', 'a11y-widget' ),
                        'manual_empty'       => __( 'Saisissez ou sélectionnez un texte à traduire.', 'a11y-widget' ),
                        'result_label'       => __( 'Résultat', 'a11y-widget' ),
                        'result_empty'       => __( 'La traduction braille apparaîtra ici.', 'a11y-widget' ),
                ...
                array(
                    ...
                    'hint'       => __( 'Convertit un texte en braille intégral (Grade 1).', 'a11y-widget' ),
                    'aria_label' => __( 'Activer le traducteur braille non contracté', 'a11y-widget' ),
                    'template'   => 'braille-translator',
                    'settings'   => array(
                        'mode'               => 'uncontracted',
                        'intro'              => __( 'Obtenez l’équivalent braille intégral d’un texte sélectionné ou saisi manuellement.', 'a11y-widget' ),
                        'selection_label'    => __( 'Texte sélectionné', 'a11y-widget' ),
                        'selection_empty'    => __( 'Sélectionnez du texte dans la page pour l’afficher ici.', 'a11y-widget' ),
                        'selection_hint'     => __( 'Après activation, surlignez du texte puis utilisez le bouton de traduction.', 'a11y-widget' ),
                        'selection_button'   => __( 'Traduire la sélection', 'a11y-widget' ),
                        'selection_missing'  => __( 'Aucun texte n’est sélectionné pour le moment.', 'a11y-widget' ),
                        'manual_label'       => __( 'Traduire un texte saisi', 'a11y-widget' ),
                        'manual_placeholder' => __( 'Tapez ou collez votre texte ici…', 'a11y-widget' ),
