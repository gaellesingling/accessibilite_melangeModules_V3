    ...
    return array(
        array(
            ...
            'children' => array(
                ...
                array(
                    'slug'       => 'vision-monophtalmie',
                    'label'      => __( 'Vision monoculaire', 'a11y-widget' ),
                    'hint'       => __( 'Aides pour compenser la perte de vision binoculaire et améliorer la perception spatiale.', 'a11y-widget' ),
                    'aria_label' => __( 'Configurer les réglages pour la vision monoculaire', 'a11y-widget' ),
                    'template'   => 'monophtalmie-support',
                    'settings'   => array(
                        'intro'                    => __( 'Ces outils facilitent la navigation avec un seul œil en renforçant la perception de profondeur et le cadrage.', 'a11y-widget' ),
                        'magnifier_label'          => __( 'Loupe adaptative', 'a11y-widget' ),
                        'magnifier_hint'           => __( 'Active une loupe centrée pour sécuriser la lecture et la sélection.', 'a11y-widget' ),
                        'zoom_label'               => __( 'Zoom progressif', 'a11y-widget' ),
                        'zoom_hint'                => __( 'Ajustez le niveau de zoom général sans déformer les contenus.', 'a11y-widget' ),
                        'zoom_value_suffix'        => __( '%', 'a11y-widget' ),
                        'zoom_decrease'            => __( 'Réduire le zoom', 'a11y-widget' ),
                        'zoom_increase'            => __( 'Augmenter le zoom', 'a11y-widget' ),
                        'depth_label'              => __( 'Indicateurs de profondeur', 'a11y-widget' ),
                        'depth_hint'               => __( 'Ajoute des repères contrastés pour distinguer l’avant et l’arrière-plan.', 'a11y-widget' ),
                        'depth_option_near'        => __( 'Renforcer le premier plan', 'a11y-widget' ),
                        'depth_option_near_hint'   => __( 'Accentue les bordures des éléments interactifs proches.', 'a11y-widget' ),
                        'depth_option_middle'      => __( 'Équilibrer la scène', 'a11y-widget' ),
                        'depth_option_middle_hint' => __( 'Répartit uniformément les repères de profondeur.', 'a11y-widget' ),
                        'depth_option_far'         => __( 'Clarifier l’arrière-plan', 'a11y-widget' ),
                        'depth_option_far_hint'    => __( 'Adoucit les arrière-plans pour limiter la fatigue visuelle.', 'a11y-widget' ),
                        'field_label'              => __( 'Adaptation du champ visuel', 'a11y-widget' ),
                        'field_hint'               => __( 'Choisissez où concentrer la zone de netteté pour compenser l’œil manquant.', 'a11y-widget' ),
                        'field_option_left'        => __( 'Champ déplacé à gauche', 'a11y-widget' ),
                        'field_option_left_hint'   => __( 'Positionne les contenus essentiels sur la gauche.', 'a11y-widget' ),
                        'field_option_center'      => __( 'Champ centré', 'a11y-widget' ),
                        'field_option_center_hint' => __( 'Maintient la zone d’attention au centre de la page.', 'a11y-widget' ),
                        'field_option_right'       => __( 'Champ déplacé à droite', 'a11y-widget' ),
                        'field_option_right_hint'  => __( 'Positionne les contenus essentiels sur la droite.', 'a11y-widget' ),
                        'low_vision_label'         => __( 'Mode vision basse', 'a11y-widget' ),
                        'low_vision_hint'          => __( 'Renforce le contraste et les contours pour stabiliser la vision.', 'a11y-widget' ),
                        'position_buttons_label'   => __( 'Position de l’interface', 'a11y-widget' ),
                        'position_buttons_hint'    => __( 'Placez les contrôles du module là où ils sont plus faciles à atteindre.', 'a11y-widget' ),
                        'position_button_left'     => __( 'Bouton à gauche', 'a11y-widget' ),
                        'position_button_center'   => __( 'Bouton centré', 'a11y-widget' ),
                        'position_button_right'    => __( 'Bouton à droite', 'a11y-widget' ),
                        'reset_label'              => __( 'Réinitialiser les réglages monophtalmie', 'a11y-widget' ),
                        'reset_aria'               => __( 'Réinitialiser tous les réglages dédiés à la vision monoculaire', 'a11y-widget' ),
                        'live_region_label'        => __( 'Notification des réglages monophtalmie', 'a11y-widget' ),
                    ),
                ),
            ),
        ),
