            ...
            'children' => array(
                array(
                    ...
                    'settings'   => array(
                        ...
                        'selection_hint'     => __( 'Activez cette option, puis surlignez un passage : la traduction s’affichera automatiquement.', 'a11y-widget' ),
                ...
                array(
                    ...
                    'settings'   => array(
                        ...
                        'selection_label'    => __( 'Texte sélectionné', 'a11y-widget' ),
                        'selection_empty'    => __( 'Sélectionnez du texte dans la page pour l’afficher ici.', 'a11y-widget' ),
                        'selection_hint'     => __( 'Après activation, surlignez du texte : la traduction s’affichera automatiquement.', 'a11y-widget' ),
                        'selection_button'   => __( 'Traduire la sélection', 'a11y-widget' ),
                        'selection_missing'  => __( 'Aucun texte n’est sélectionné pour le moment.', 'a11y-widget' ),
                        'selection_truncated' => __( 'Seuls les 600 premiers caractères de la sélection ont été traduits.', 'a11y-widget' ),
                        'manual_label'       => __( 'Traduire un texte saisi', 'a11y-widget' ),
