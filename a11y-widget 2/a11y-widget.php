        ...
        array(
            ...
            'children' => array(
                array(
                    ...
                    'settings'   => array(
                        'intro'             => __( 'Sélectionnez du texte ou faites lire toute la page automatiquement. Compatible avec la Web Speech API des navigateurs.', 'a11y-widget' ),
                        ...
                        'voice_hint'        => __( 'Les voix disponibles dépendent de votre système.', 'a11y-widget' ),
                        'voice_default'     => __( 'Voix du navigateur (auto)', 'a11y-widget' ),
                        'voice_loading'     => __( 'Chargement des voix…', 'a11y-widget' ),
                        'info_tip'          => __( 'Astuce : sélectionnez un passage puis cliquez sur « Lire » pour l’écouter.', 'a11y-widget' ),
                        'info_shortcuts'    => __( 'Raccourcis : barre espace = lecture/pause • Échap = stop', 'a11y-widget' ),
